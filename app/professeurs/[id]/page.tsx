...
import ProfDashboardPage from './profdashboard';
...
export default function ProfPage() {
  ...
  useEffect(() => {
    ...
    const loadProfessors = async () => {
      setLoading(true);
      try {
        // REQUÊTE SUPABASE : Exclut les admins et les emails spécifiques des administrateurs
        ...
        if (error) {
          ...
          // DOUBLE SÉCURITÉ JAVASCRIPT : Filtrage strict par is_admin et par emails
